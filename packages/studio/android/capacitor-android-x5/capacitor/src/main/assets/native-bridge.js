...
var nativeBridge = (function (exports) {
    ...
    const initBridge = (w) => {
        ...
        function initNativeBridge(win) {
            ...
            // create the postToNative() fn dynamically if needed
            const getPostToNative = () => {
                if (postToNative) return postToNative;
                const platform = getPlatformId(win);
                if (platform === 'android') {
                    postToNative = (data) => {
                        var _a;
                    ...
                    if (win.androidBridge && !win.androidBridge.onmessage) {
