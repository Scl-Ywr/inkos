...
export function PlayHud(props: {
  ...
  return (
    <aside className="absolute inset-x-0 bottom-0 top-auto z-40 flex max-h-[72dvh] w-full flex-col overflow-hidden rounded-t-3xl border-t border-border/50 bg-card/97 pb-[env(safe-area-inset-bottom)] shadow-2xl backdrop-blur lg:bottom-28 lg:left-auto lg:right-0 lg:top-0 lg:max-h-none lg:w-[380px] lg:max-w-[calc(100vw-1rem)] lg:rounded-none lg:border-l lg:border-t-0 lg:pb-0 lg:shadow-xl">
