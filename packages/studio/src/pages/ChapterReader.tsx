...
export function ChapterReader({ bookId, chapterNumber, nav, theme, t }: {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 fade-in">
      ...
      {/* Manuscript Sheet */}
      <div className="paper-sheet rounded-2xl p-4 sm:p-8 md:p-16 lg:p-24 shadow-2xl shadow-primary/5 min-h-[80vh] relative overflow-hidden">
        ...
        {editing ? (
          <textarea
            ...
            className="w-full min-h-[60vh] bg-transparent font-serif text-base sm:text-lg leading-[1.8] text-foreground/90 focus:outline-none resize-none border border-border/30 rounded-lg p-3 sm:p-6 focus:border-primary/40 focus:ring-2 focus:ring-primary/10 transition-all"
            autoFocus
          />
        ) : (
